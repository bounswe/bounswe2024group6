# Generated by Django 4.2.2 on 2024-05-16 19:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entity_id', models.CharField(default='', max_length=150)),
        ...
        migrations.AddField(
            model_name='post',
            name='SearchResult',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='app.searchresult'),
        ),
        migrations.AddField(
            model_name='post',
            name='author',
