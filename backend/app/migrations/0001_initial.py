# Generated by Django 4.2.17 on 2024-12-10 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_type', models.CharField(choices=[('EN_TR', 'English to Turkish'), ('TR_EN', 'Turkish to English'), ('EN_DEF', 'English to Definition')], max_length=10)),
            ...
            options={
                'indexes': [models.Index(fields=['word', 'quiz_type'], name='app_wordcho_word_977414_idx')],
            },
        ),
        migrations.CreateModel(
            name='Translation',
