...
export default function QuizDetails() {
  ...
  const [hasAttempted, setHasAttempted] = useState(
    quizData?.has_unfinished_progress
  );
        ...
        <Card className="max-w-[600px] items-center">
          <CardHeader className="flex flex-col items-start gap-2">
            <div className="flex w-full justify-between items-center px-1">
              ...
              <p className="text-default-400 items-center text-small">
                {quizData?.timestamp}
              </p>
            </div>
          ...
          <CardBody className="flex flex-col justify-start rounded-lg shadow-zinc-200 w-[550px] h-[300px] overflow-hidden mb-2">
            ...
            <div className="flex flex-col justify-center mx-3">
              <div className="flex flex-row justify-between">
                <div>
                  <p className="w-full items-center text-lg mb-4 text-default-500 opacity-80">
                ...
                {quizData?.title_image ? (
                  <img
                    src={quizData.title_image}
                    alt="quiz"
                    onError={(e) => {
                      e.currentTarget.onerror = null; // Prevent infinite loop
                      e.currentTarget.src = "path/to/fallback/image.png"; // Optional: provide fallback image
                    }}
                    style={{
                      width: "170px",
                      height: "170px",
